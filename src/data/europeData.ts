...
export const wikiSearchTerms: Record<string, { nl: string; en: string }> = {
  ...
  austria: { nl: 'Oostenrijk', en: 'Austria' },
  italy: { nl: 'Italië', en: 'Italy' },
  germany: { nl: 'Duitsland', en: 'Germany' },
  poland: { nl: 'Polen', en: 'Poland' },
  norway: { nl: 'Noorwegen', en: 'Norway' },
  sweden: { nl: 'Zweden', en: 'Sweden' },
  russia: { nl: 'Rusland', en: 'Russia' },
  amsterdam: { nl: 'Amsterdam', en: 'Amsterdam' },
  brussels: { nl: 'Brussel', en: 'Brussels' },
  luxembourg_city: { nl: 'Luxemburg (stad)', en: 'Luxembourg City' },
  london: { nl: 'Londen', en: 'London' },
  paris: { nl: 'Parijs', en: 'Paris' },
  madrid: { nl: 'Madrid', en: 'Madrid' },
  bern: { nl: 'Bern (stad)', en: 'Bern' },
  vienna: { nl: 'Wenen', en: 'Vienna' },
  rome: { nl: 'Rome', en: 'Rome' },
  berlin: { nl: 'Berlijn', en: 'Berlin' },
  warsaw: { nl: 'Warschau', en: 'Warsaw' },
  oslo: { nl: 'Oslo', en: 'Oslo' },
  stockholm: { nl: 'Stockholm', en: 'Stockholm' },
  moscow: { nl: 'Moskou', en: 'Moscow' },
  ...
  english_channel: { nl: 'Het Kanaal', en: 'English Channel' },
